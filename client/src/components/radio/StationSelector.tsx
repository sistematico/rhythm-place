...
export function StationSelector() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-6">
      <h2 className="text-2xl font-bold text-white mb-6 text-center">Escolha seu estilo</h2>
        ...
        {stations.map((station) => (
          <button
            ...
            className={`
              ...
              ${currentStation?.id === station.id ? 'bg-gradient-to-br from-purple-600 to-pink-600 shadow-lg shadow-purple-500/50' : 'bg-gray-800 hover:bg-gray-700'}
            `}
          >
