  ...
  return (
    <main className="space-scene relative flex min-h-screen items-center justify-center overflow-hidden px-6 py-10 text-white">
      ...
      <div className="relative z-10 flex w-full max-w-3xl items-center justify-center">
        <div className="w-full rounded-[2rem] border border-white/12 bg-white/8 px-8 py-10 text-center shadow-[0_30px_100px_rgba(2,6,23,0.55)] backdrop-blur-xl sm:px-12 sm:py-12">
